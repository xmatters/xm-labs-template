...
# Files
* [MySweetCommPlan.zip](MySweetCommPlan.zip) - The communication plan that has all the cool scripts, email formats, property lists, and such. (If it doesn't make sense to have a full communication plan, then you can just use a couple javascript files like the one below.)
* [FileA.js](FileA.js) - The javascript file to be pasted into a Shared Library in the Integration builder. It does xyz. 
